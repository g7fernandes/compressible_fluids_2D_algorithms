...
U,V,Rho = np.zeros((len(celulas))),np.zeros((len(celulas))),np.zeros((len(celulas)))
...
##
            RBn2 = np.copy(RBn)
            RBs2 = np.copy(RBs)
            invRBn2 = np.copy(invRBn)
            invRBs2 = np.copy(invRBs)
            
            invRBn2[1,1],invRBn2[2,2],invRBn2[2,1],invRBn2[1,2] = RB[el,1],RB[el,1],RB[el,0],-RB[el,0]
            
            invRBs2[1,1],invRBs2[2,2],invRBs2[2,1],invRBs2[1,2] = RB[viz[el,2],1],RB[viz[el,2],1],RB[viz[el,2],0],-RB[viz[el,2],0]
            
            RBn2[1,1],RBn2[2,2],RBn2[2,1],RBn2[1,2] = RB[el,1],RB[el,1],-RB[el,0],+RB[el,0]
            
            RBs2[1,1],RBs2[2,2],RBs2[2,1],RBs2[1,2] = RB[viz[el,2],1],RB[viz[el,2],1],-RB[viz[el,2],0],RB[viz[el,2],0]

#            RAe2 = np.copy(RAe)
#            RAw2 = np.copy(RAw)
#            invRAe2 = np.copy(invRAe)
#            invRAw2 = np.copy(invRAw)
#            
#            invRAe2[1,1],invRAe2[2,2],invRAe2[2,1],invRAe2[1,2] = RA[el,1],RA[el,1],RA[el,0],-RA[el,0]
#            
#            invRAw2[1,1],invRAw2[2,2],invRAw2[2,1],invRAw2[1,2] = RA[viz[el,3],1],RA[viz[el,3],1],RA[viz[el,3],0],-RA[viz[el,3],0]
#            
#            RAe2[1,1],RAe2[2,2],RAe2[2,1],RAe2[1,2] = RA[el,1],RA[el,1],-RA[el,0],+RA[el,0]
#            
#            RAw2[1,1],RAw2[2,2],RAw2[2,1],RAw2[1,2] = RA[viz[el,3],1],RA[viz[el,3],1],-RA[viz[el,3],0],RA[viz[el,3],0]
